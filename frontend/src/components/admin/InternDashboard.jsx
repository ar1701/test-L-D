      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-gray-200/50 shadow-lg">
          ...
          <CardContent className="p-6">
            {/* Filters Section */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6 p-4 sm:p-6 bg-gradient-to-r from-gray-50 to-emerald-50 rounded-xl border border-gray-200/50 shadow-sm">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-gray-200/50 shadow-lg mt-8">
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="flex items-center justify-center">
                                <Button
                                  variant="ghost"
                                  size="sm"
                                  onClick={() => handleViewDemoAdminNote(demo)}
                                  className="h-8 w-8 p-0 opacity-50 hover:opacity-100"
                                  title="View Admin Note"
                                >
                                  <Eye className="h-4 w-4" />
                            ...
                            <TableCell className="text-right">
                              <DropdownMenu>
                                ...
                                >
                                  <DropdownMenuItem
                                    onClick={() => handleViewDemoDetails(demo)}
                                    className="hover:bg-blue-50"
                                  >
                                    <Eye className="h-4 w-4 mr-2" />
                                    View Details
